...
/**
 * Java Representation of a Template //todo: Old one
 */
public class TemplateOld {
    ...
    public TemplateOld(String name, String type, int maximumInstances, int maximumNumberOfNodes, String description, String javascript, Collection<String> siddhiApps, Map<String, Map<String, String>> properties) {
        this.name = name;
        this.type = type;
